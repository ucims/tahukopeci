              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    echo form_open('Control_User/edit', $attributes); ?>                                 
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ID User 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('id_user', $get_data['id_user'], array('placeholder' => 'Id User','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12', 'readonly' => 'true')); ?>
                        </div>
                      </div> 
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('username', $get_data['username'], array('placeholder' => 'Username','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                      </div> 
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('fullname', $get_data['fullname'], array('placeholder' => 'Fullname','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                      </div>  
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('password', $get_data['password'], array('placeholder' => 'Password','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                      </div>                                  
                      <div class="form-group">
