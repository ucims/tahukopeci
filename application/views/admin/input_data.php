            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <?php 
                  if ($this->session->flashdata('simpan_ramalan') == 'Berhasil') {
                    ...
                    Data ke 1 :<br>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('tahun[]', '', array('placeholder' => 'Tahun','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                      </div>                                      
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php echo form_input('data_rill[]', '', array('placeholder' => 'Data Bahan baku','required' => 'true', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                      </div>                    
                     <!-- <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <button class="btn btn-primary" type="reset">Reset</button>
                          ...
                          echo form_submit('tampilkan_data','Tampilkan', array('class' => 'btn btn-success'));
